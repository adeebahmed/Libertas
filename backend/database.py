...
DEFAULT_DB_PATH = os.path.join(os.path.dirname(os.path.dirname(__file__)), "data", "libertas.db")
DB_PATH = os.path.abspath(os.environ.get("LIBERTAS_DB_PATH", DEFAULT_DB_PATH))
